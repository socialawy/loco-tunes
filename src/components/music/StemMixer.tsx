                ...
                <div className="flex items-center gap-1">
                  ...
                  {stem.type === 'melody' && (
                    <Button
                      ...
                      size="icon"
                      onClick={() => {
                        const name = prompt('Name this motif:');
                        if (name) {
                          saveMotif(name, stem.notes.filter(n => n.startTime < 8));
                        }
                      }}
                      className="h-8 w-8 text-green-400 hover:text-green-300 hover:bg-[#2a2a4e]"
                      title="Save as motif"
                    >
