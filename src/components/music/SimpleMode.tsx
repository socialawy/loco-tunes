  ...
  return (
    <div className="space-y-6 p-6 bg-[#16162a] rounded-xl border border-[#2a2a4e]">
      ...
      {savedMotifs.length > 0 && (
        <div className="space-y-2">
          <Label className="text-gray-300">Use Saved Motif (Melody)</Label>
          <Select
            value={params.useSavedMotifId || "none"}
            onValueChange={(value) => setParams({ useSavedMotifId: value === "none" ? undefined : value })}
          >
            <SelectTrigger className="bg-[#1a1a2e] border-[#2a2a4e] text-white">
              <SelectValue placeholder="None (Generate New)" />
            </SelectTrigger>
            <SelectContent className="bg-[#1a1a2e] border-[#2a2a4e]">
